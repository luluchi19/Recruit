...
exports.FormRegister = function () {
    ...
    return (React.createElement(React.Fragment, null,
        React.createElement("form", { id: "registerForm", action: "", className: "grid grid-cols-1 gap-y-[15px]" },
            React.createElement("div", { className: "" },
                React.createElement("label", { htmlFor: "companyName", className: "block font-[500] text-[14px] text-black mb-[5px]" }, "T\u00EAn c\u00F4ng ty *"),
                React.createElement("input", { type: "text", name: "companyName", id: "companyName", className: "w-[100%] h-[46px] border border-[#DEDEDE] rounded-[4px] py-[14px] px-[20px] font-[500] text-[14px] text-black" })),
            React.createElement("div", { className: "" },
            ...
            React.createElement("div", { className: "" },
                React.createElement("button", { className: "bg-[#0088FF] rounded-[4px] w-[100%] h-[48px] px-[20px] font-[700] text-[16px] text-white" }, "\u0110\u0103ng k\u00FD")))));
};
