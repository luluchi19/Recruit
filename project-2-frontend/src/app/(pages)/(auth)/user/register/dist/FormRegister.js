    ...
    return (React.createElement(React.Fragment, null,
        React.createElement("form", { id: "registerForm", action: "", className: "grid grid-cols-1 gap-y-[15px]" },
            React.createElement("div", { className: "" },
                ...
                React.createElement("input", { type: "text", name: "fullName", id: "fullName", className: "w-[100%] h-[46px] border border-[#DEDEDE] rounded-[4px] py-[14px] px-[20px] font-[500] text-[14px] text-black" })),
            React.createElement("div", { className: "" },
