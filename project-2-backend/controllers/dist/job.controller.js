...
exports.detail = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var id, record, jobDetail, companyInfo, error_1;
...
exports.applyPost = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var newRecord;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                req.body.fileCV = req.file ? req.file.path : "";
                newRecord = new cv_model_1["default"](req.body);
